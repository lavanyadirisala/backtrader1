 ...
 * org.mockito.ArgumentMatchers.any; import static org.mockito.Mockito.doThrow;
 * 
 * import org.junit.Test; import org.junit.runner.RunWith; import
 * org.mockito.ArgumentCaptor; import org.mockito.Captor; import
 ...
 * 
 * @RunWith(MockitoJUnitRunner.class) public class MailTest {
 * 
 ...
 * 
 * @Test public void testSendSimpleMail_Success() throws MessagingException { //
 * Arrange String email = "test@example.com"; String expectedBody =
 * "<p>Hello,</p>" + "<p>You have requested to reset your password.</p>" +
 * "<p>Click the link below to change your password:</p>" +
 * "<p><a href=\"url\">Change my password</a></p>";
 * 
 * // Act String result = emailService.sendSimpleMail(email);
 * 
 * // Assert assertEquals("MAIL_SENT_SUCCESSFULLY...", result);
 * 
 ...
 * }
 * 
 * @Test public void testSendSimpleMail_Exception() throws MessagingException {
 * // Arrange String email = "test@example.com"; doThrow(new
 * MailSendException("Mail sending failed")).when(javaMailSender).send(any(
 * MimeMessage.class));
 * 
 * // Act String result = emailService.sendSimpleMail(email);
 * 
 * // Assert assertEquals("Error while Sending Mail", result); } }
 */